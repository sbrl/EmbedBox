 ...
 * Lifted from Air-Quality-Web: https://github.com/ConnectedHumber/Air-Quality-Web/blob/master/lib/SBRL/PerformanceCounter.php
 */
class PerformanceCounter
{
	...
	/**
	 * Creates a new performance counter instance
	 */
